                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 align-self-center">
                                ...
                                <span>Free TV</span><br>
								<span class="material-icons">dining</span>
                                <span>Free dining</span><br>
								<span class="material-icons">support_agent</span>
                                <span>support_agent</span><br>
                            </div>
                            <div class="col-md-4 align-self-center text-center">
                                ...
                                <button class="btn btn-primary book_now mt-3" type="button" data-id="<?php echo $row['category_id'] ?>">Book now</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<style type="text/css">
	...
	.align-self-center .material-icons {
