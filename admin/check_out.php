                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php 
                                        $category_name = 'Not filled';
                                        if (isset($room_arr[$row['room_id']]) && isset($cat_arr[$room_arr[$row['room_id']]['category_id']])) {
                                            $category_name = $cat_arr[$room_arr[$row['room_id']]['category_id']]['name'];
                                        }
                                        echo $category_name;
                                        ?>
                                    </td>
                                    <td class="">
                                        <?php 
                                        $room_name = 'Not Filled';
                                        if (isset($room_arr[$row['room_id']])) {
                                            $room_name = $room_arr[$row['room_id']]['room'];
                                        }
                                        echo $room_name;
                                        ?>
                                    </td>
